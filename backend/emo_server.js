...
var ngram_search = req.body.ngram_search;
console.log("ngram_search is "+ngram_search);
		if(ngram_search=="false") {
		console.log("Doing MAW search!");
		...
		console.log("Doing ngram search!");
			var qstring = cp.execSync('/home/mas01tc/emo_search/web-demo/do-process_for_ngrams.sh '+ sampleFile.name +' '+ w_path + ' '+ng_len);
...
//	fs.readFile(db_name,'utf8',(err,data) => {
	var data=fs.readFileSync(db_name,'utf8');
		load_data(data);
}
