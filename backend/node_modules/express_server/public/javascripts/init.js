...
$(function () {
	...
	$.backstretch([
		"img/background/nodulisland_01.jpg",
		"img/background/nodulisland_02.jpg",
		"img/background/nodulisland_03.jpg",
		"img/background/nodulisland_04.jpg",
		"img/background/patterningworkshop_01.jpg",
	...
	// year/month/day
	$('#countdown').countdown('2015/3/1', function (event) {
