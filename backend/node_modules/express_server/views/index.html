...
<html lang="en">
	<head>
		...
		<meta name="author" content="http://chunjee-partners.com">
		<title>Chun & Jee Partners</title>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.html">
                    <img src="img/blog/logo.png" alt="Minimal logo" class="hidden-xs hidden-sm">
                    <img src="img/blog/logo-small.png" alt="Minimal logo" class="visible-xs visible-sm"><span class="sr-only">Minimal - go to homepage</span>
                </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <img src="img/blog/men.jpg" class="img-responsive hidden-xs" alt="">
                                        </div>
                                        <div class="col-sm-3">
                                            <h3>Clothing</h3>
                                            <ul>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <img src="img/blog/women.jpg" class="img-responsive hidden-xs" alt="">
                                        </div>
                                        <div class="col-sm-3">
                                            <h3>Clothing</h3>
                                            <ul>
			...
			<div class="page">
				<div class="wrapper">
					<div class="container">
						...
						<!-- Subscription form -->
						<form class="form-inline signup" action="/lists/604ce69ff0/subscribe/" method="post" role="form" id="signupForm">
		...
		<section id="about" class="section">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<p class="lead">
							<strong>Curabitur molestie</strong> libero ut enim egestas 
							placerat. Sed facilisis magna sapien, id tincidunt metus 
							adipiscing sed. Aliquam viverra sagittis quam vel sagittis. 
						</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
							Mauris interdum condimentum vestibulum. Proin ullamcorper 
							lorem adipiscing elit ornare, et lobortis tortor fringilla. 
							Curabitur non volutpat justo, at posuere dolor.
							Fusce eu tellus vel tellus porttitor aliquet. Etiam ullamcorper 
							laoreet lectus ut suscipit. Quisque luctus felis sed ante elementum condimentum. 
							Praesent sagittis odio eu ante sollicitudin, vel commodo 
							odio viverra. 
						</p>
						<div class="row">
			...
			<div class="carousel-container">
				<div id="teamCarousel" class="owl-carousel text-center">
					<div class="text-center team-member-container wow fadeInDown">
						<div class="team-member">
							<div class="team-member-img">
								<img src="img/portraits/profile_jhchun_01.jpg" alt="" class="img-responsive">
							</div>
							<div class="team-member-meta">
								<h4>Chun</h4>
								<span class="team-member-profession">Developer</span>
								<p>Fusce pulvinar dui eu dignissim semper. Donec non tellus felis. Vivamus dapibus placerat.</p>
								<div class="social">
									<a href="#" class="btn btn-theme"><i class="fa fa-facebook"></i></a>
									<a href="#" class="btn btn-theme"><i class="fa fa-twitter"></i></a>
									<a href="#‎" class="btn btn-theme"><i class="fa fa-google-plus"></i></a>
					...
					<div class="text-center team-member-container wow fadeInDown" data-wow-delay="0.2s">
						<div class="team-member">
							<div class="team-member-img">
								<img src="img/portraits/profile_wgjee_01.jpg" alt="" class="img-responsive">
							</div>
							<div class="team-member-meta">
								<h4>Jee</h4>
								<span class="text-muted team-member-profession">Designer</span>
								<p>Sed posuere eu sem ac consectetur. Integer suscipit diam odio, in tincidunt dui aliquet eget.</p>
								<div class="social">
									<a href="#" class="btn btn-theme"><i class="fa fa-facebook"></i></a>
									<a href="#" class="btn btn-theme"><i class="fa fa-twitter"></i></a>
									<a href="#‎" class="btn btn-theme"><i class="fa fa-google-plus"></i></a>
					...
					<div class="text-center team-member-container wow fadeInDown" data-wow-delay="0.4s">
						<div class="team-member">
							<div class="team-member-img">
								<img src="img/portraits/profile_hjohn_01.jpg" alt="" class="img-responsive">
							</div>
							<div class="team-member-meta">
								<h4>Choi</h4>
								<span class="team-member-profession">CEO</span>
								<p>Vivamus dapibus placerat tincidunt. 
									Donec sit amet justo eget dolor vehicula tincidunt eu ut est.
								</p>
								<div class="social">
									<a href="#" class="btn btn-theme"><i class="fa fa-facebook"></i></a>
									<a href="#" class="btn btn-theme"><i class="fa fa-twitter"></i></a>
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<ul class="list-contacts">
							...
							<li><i class="fa fa-envelope-o"></i> <a href="mailto:info@seventytwo.com">info@seventytwo.com</a></li>
						</ul>
					</div>
					<div class="col-sm-6">
